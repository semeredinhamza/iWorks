            ...
            <div class="jumbotron">
                ...
                <div class="row ">
                    ...
                    <div class="card col-lg-4 col-md-4 mb-4">
                        <div class="card-body">
                            <p>
                                <h5>Title: </h5><c:out value="${job.getTitle()}" />
                            </p>
                            <p>
                                <h5>Institution: </h5><c:out value="${job.getInstitution()}" />
                            </p>
                            <p>
                                <h5>Period: </h5><c:out value="${job.getPeriod()}" />
                            </p>
                            <p>
                                <h5>Location: </h5><c:out value="${job.getLocation()}" />
                            </p>
                            <p>
                                <h5>Description: </h5><c:out value="${job.getDescription()}" />
                            </p>
                            <a href="${job.getLink()}" class="btn btn-primary stretched-link">Go To Employer Website</a>
                        </div>
                    </div>
					</c:forEach>
                </div>
